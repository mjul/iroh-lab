...
enum Message {
    ...
    TopicCreated(Result<(String, String), String>),
                        ...
                        return Command::perform(
                            async move {
                                if let Some(endpoint) = endpoint {
                                    ...
                                    // Generate a ticket for the topic (placeholder)
                                    // In a real implementation, this would be generated by Iroh
                                    let ticket = format!("iroh-ticket-{}-{}", topic_name, Uuid::new_v4().to_string());
                                    
                                    Ok((topic_name, ticket))
                                } else {
